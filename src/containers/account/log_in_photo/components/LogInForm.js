  ...
  render() {
    ...
    return (
      <form className='form' onSubmit={handleSubmit}>
        ...
        <Link className='btn btn-primary account__btn account__btn--small' to='/dashboard_default'>Sign In</Link>
        <Link className='btn btn-outline-primary account__btn account__btn--small' to='/register_photo'>Create
          Account</Link>
      </form>
    )
  }
